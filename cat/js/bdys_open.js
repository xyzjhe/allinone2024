...
async function detail(id) {
    try {
        ...
        let $ = load(html);
        let content = '该影视由leospring采集分享，公众号【蹲街捏蚂蚁】，请勿传播分享，仅供技术学习使用，请在学习后24小时内删除；由此产生的任何法律风险自行承担，与本作者无关！' + $('#synopsis > div.card-body').text();
...
async function genFilterObj() {
    ...
    return {
        '0': [{'key': 'type', 'name': '类型', 'init': '/s/all','value': types}, 
            {'key': 'area', 'name': '地区', 'init': '中国大陆', 'value': areas}, 
